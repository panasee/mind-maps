...
<text>用途：建立理解利益冲突、合作与策略选择的实用框架。优先理解核心概念、适用条件和日常例子。
总图保留概念骨架；合作与谈判、信息与激励在专题图中扩展，标题可跳转。
填充建议：概念含义 → 典型情境 → 关键条件 → 可能的回应与结果。详细案例保存在所属专题。
...
<node TEXT="7. 信息与激励" POSITION="bottom_or_right" ID="ID_GT_information" CREATED="1789314599206" MODIFIED="1789314599206" LINK="InformationAndIncentives.mm">
<edge COLOR="#0033ff"/>
</node>
<node TEXT="8. 应用场景与心理学联系" FOLDED="true" POSITION="bottom_or_right" ID="ID_GT_applications" CREATED="1789314599206" MODIFIED="1789314599206">
<edge COLOR="#18898b"/>
<node TEXT="日常合作：分工、承诺与长期关系" ID="ID_GT_root_58" CREATED="1789314599206" MODIFIED="1789314599206" LINK="CooperationAndBargaining.mm#ID_GT_coop_trust"/>
<node TEXT="商业竞争：定价、进入与差异化" ID="ID_GT_root_59" CREATED="1789314599206" MODIFIED="1789314599206"><richcontent TYPE="NOTE">
<text>先判断对方能采取哪些回应、是否存在共同收益以及竞争规则如何改变激励。</text></richcontent>
</node>
<node TEXT="交易与金融：信息差、激励与预期互动" ID="ID_GT_root_60" CREATED="1789314599206" MODIFIED="1789314599206" LINK="InformationAndIncentives.mm#ID_GT_info_beliefs"/>
<node TEXT="组织与平台：考核、分配与规则" ID="ID_GT_root_61" CREATED="1789314599206" MODIFIED="1789314599206" LINK="InformationAndIncentives.mm#ID_GT_info_agency"/>
<node TEXT="决策心理：有限理性、情绪与参照点" ID="ID_GT_root_62" CREATED="1789314599206" MODIFIED="1789314599206" LINK="DecisionMaking.mm#ID_189576474"/>
<node TEXT="社会心理：归因、规范与关系" ID="ID_GT_root_63" CREATED="1789314599206" MODIFIED="1789314599206" LINK="SocialPsychology.mm#ID_1686770776"/>
